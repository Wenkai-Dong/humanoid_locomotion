...
ATTENTION_TERRAINS_CFGv1 = TerrainGeneratorCfg(
    curriculum=True,
    size=(10.0, 10.0),
    border_width=10,
    num_rows=10,
    ...
    sub_terrains={
        ...
        "GridStones": terrain_gen.HfSteppingStonesTerrainCfg(
            function=hf_terrains.stepping_stones_height_terrain,
            proportion=0.2,
        ...
        "Pallets": dual_gate_terrain_gen.HfPalletsTerrainCfg(
            proportion=0.2,
            pallet_height=(0.0, 0.2),
            pallet_width_range=(0.3, 0.5),
            pallet_distance_range=(0.1, 0.5),
            platform_width=1.0,
            border_width=1.0,
        ),
