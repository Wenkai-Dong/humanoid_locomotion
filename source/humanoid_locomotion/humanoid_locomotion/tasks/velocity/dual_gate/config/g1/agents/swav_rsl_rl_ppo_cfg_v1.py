...
from humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.rl_cfg import (
    ...
    RslRlPpoVAEAlgorithmCfg,
    RslRlPpoSwAVAlgorithmCfg,
...
class G1RoughPPORunnerCfg(RslRlOnPolicyRunnerCfgNew):
    ...
    actor = RslRlCNNVelocityModelCfg(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.swav_model_v1:SwAVModel",
    ...
    algorithm = RslRlPpoSwAVAlgorithmCfg(
        class_name= "humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.algorithms.ppo_swav_v1:PPOSwAV",
        value_loss_coef=1.0,
