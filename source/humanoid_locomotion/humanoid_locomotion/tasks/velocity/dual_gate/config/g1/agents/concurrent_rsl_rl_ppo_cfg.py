...
class G1RoughPPORunnerCfg(RslRlOnPolicyRunnerCfgNew):
    ...
    actor = RslRlCNNVelocityModelCfg(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.concurrent_model:ConcurrentModel",
    ...
    algorithm = RslRlPpoAEAlgorithmCfg(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.algorithms.ppo_concurrent:PPOConcurrent",
        value_loss_coef=1.0,
