...
@configclass
class G1RoughPPORunnerAttnPoolCfg(RslRlOnPolicyRunnerCfgNew):
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 300
    experiment_name = "Dual-G1-v0/gated_pool"
    obs_groups = {
    ...
    actor = RslRlGatedModelCfgv1(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.gated_model_v1_attnpool:GatedMHAModel",
...
@configclass
class G1RoughPPORunnerMaxPoolCfg(G1RoughPPORunnerAttnPoolCfg):
    def __post_init__(self):
        super().__post_init__()
        self.actor.class_name = "humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.gated_model_v1_maxpool:GatedMHAModel"
        self.critic.class_name = "humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.gated_model_v1_maxpool:GatedMHAModel"
