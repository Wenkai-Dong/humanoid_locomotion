...
class G1RoughPPORunnerCfg(RslRlOnPolicyRunnerCfgNew):
    ...
    actor = RslRlCNNVelocityModelCfg(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.swav_s_model:SwAVModel",
    ...
    algorithm = RslRlPpoSwAVAlgorithmCfg(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.algorithms.ppo_swav_s:PPOSwAV",
        value_loss_coef=1.0,
