...
class G1RoughPPORunnerCfg(RslRlOnPolicyRunnerCfgNew):
    ...
    save_interval = 300
    experiment_name = "Attention-G1-v3/gated_swav_v1"
    obs_groups = {
    ...
    actor = RslRlCNNVelocityModelCfg(
        class_name="humanoid_locomotion.tasks.velocity.dual_gate.custom_rslrl.models.gated_swav_model_v1:GatedSwAVModel",
