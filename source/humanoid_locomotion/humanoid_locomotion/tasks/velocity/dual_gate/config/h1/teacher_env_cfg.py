...
class ObservationsCfg:
    ...
    class ActorCfg(ObsGroup):
        ...
        # left observation terms (order preserved)
        ...
        body_pose_vel_l = ObsTerm(
            func=mdp.body_pose_vel,
            scale=1,
            params={
                "asset_cfg": SceneEntityCfg("robot", body_names="left_ankle_link"),
            }
        )
        contact_forces_l = ObsTerm(
            func=mdp.contact_forces,
            params={
                "sensor_cfg": SceneEntityCfg("contact_forces", body_names="left_ankle_link"),
                "robot_mass": 47.,
            }
        )
        joint_effort_r = ObsTerm(
            func=mdp.joint_effort,
            scale=0.05,
            params={
                "asset_cfg": SceneEntityCfg(
        ...
        contact_forces_r = ObsTerm(
            func=mdp.contact_forces,
            params={
                "sensor_cfg": SceneEntityCfg("contact_forces", body_names="right_ankle_link"),
                "robot_mass": 47.,
            }
        )
