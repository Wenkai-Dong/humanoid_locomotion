...
gym.register(
    id="Velocity-DualGate-Teacher-H1-v0",
...
gym.register(
    id="Velocity-DualGate-Teacher-H1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Velocity-DualGate-Teacher-H1-Eval-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.eval_env_cfg:H1EvalEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:H1TeacherPPORunnerCfg",
    },
)