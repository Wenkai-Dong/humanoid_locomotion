...
class PPOSwAV:
    ...
    def __init__(
        ...
        self.swav_params = list(chain(
            ...
            self.actor.target_left.parameters(),
            self.actor.target_right.parameters(),
            self.actor.proto_left.parameters(),
            self.actor.proto_right.parameters(),
        ))
    ...
    def update(self) -> dict[str, float]:
        ...
        for batch in generator:
            ...
            privilege = ((batch.observations["critic"] - self.critic.obs_normalizer._mean) /
                         (self.critic.obs_normalizer._std + self.critic.obs_normalizer.eps))[:, 99:]
