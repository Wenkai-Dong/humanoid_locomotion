...
class PPOAE:
    ...
    def __init__(
        ...
        self.ae_params = list(chain(
            ...
            self.actor.decoder_left.parameters(),
            self.actor.decoder_right.parameters()
        ))
        autoencoder_ids = {id(p) for p in self.ae_params}
        self.ppo_params = [
        ...
        self.optimizer = resolve_optimizer(optimizer)([
            ...
            {"params": self.ae_params, "lr": learning_rate, "name": "ae"},
        ])  # type: ignore
    ...
    def update(self) -> dict[str, float]:
        ...
        for batch in generator:
            ...
            nn.utils.clip_grad_norm_(self.ae_params, 10.0)
            self.optimizer.step()
